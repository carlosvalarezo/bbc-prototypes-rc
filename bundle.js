...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StoriesContainer = __webpack_require__(2);
	...
	var whatwg = __webpack_require__(176);


	var SportsContainer = React.createClass({
	    displayName: 'SportsContainer',
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        fetch('./db/football28040255.json').then(function (response) {
	            ...
	            _this.setState({ storiesList: storiesListTemp });
	        }).catch(function (ex) {
	    ...
	    render: function render() {
	        return React.createElement(_StoriesContainer2.default, { storiesList: this.state.storiesList });
	    }
	});

	ReactDOM.render(React.createElement(SportsContainer, null), document.getElementById("root"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StoryContainer = __webpack_require__(3);
	...
	var StoriesContainer = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'div',
	            { className: '' },
	            React.createElement(_StoryContainer2.default, { id: 'type-a-top-story-1',
	                stories: this.props.storiesList.filter(function (story) {
	                    return story.type === "type-a-top-story-1";
	                })
	            }),
	            React.createElement(_StoryContainer2.default, { id: 'type-a-story-1',
	                stories: this.props.storiesList.filter(function (story) {
	                    return story.type === "type-a-story-1";
	                })
	            }),
	            React.createElement(_StoryContainer2.default, { id: 'type-a-headline-list-1',
	                stories: this.props.storiesList.filter(function (story) {
	                    return story.type === "type-a-headline-list-1";
	                })
	            })
	        );
	    }
	...
	var StoryContainer = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var stories = this.props.stories.map(function (story) {
	            return _this.props.id === "type-a-top-story-1" ? React.createElement(
	                'div',
	                { className: _this.props.id + "-container" },
	                React.createElement(_Story2.default, { id: _this.props.id, story: story.items, key: story.title })
	            ) : _this.props.id === "type-a-story-1" ? React.createElement(
	                'div',
	                { className: _this.props.id + "-container" },
	                React.createElement(_Story2.default, { id: _this.props.id, story: story.items, key: story.title })
	            ) : React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MediaContainer = __webpack_require__(5);

	var _MediaContainer2 = _interopRequireDefault(_MediaContainer);

	var _SharingButton = __webpack_require__(45);
	...
	var Story = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var story = this.props.story.map(function (item) {
	            ...
	            var completeURL = "http://www.bbc.co.uk" + item.assetUri;
	            return React.createElement(
	                'article',
	                null,
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: _this.props.id + "-title" },
	                            item.headline,
	                            ' ',
	                            item.title
	                        ),
	                        ...
	                        React.createElement(_MediaContainer2.default, { id: _this.props.id, media: item.media })
	                    )
	                ),
	                React.createElement(_SharingButton2.default, { shareLink: completeURL })
	            );
	        });
	        return React.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MediaContainer = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var mediaType = Object.keys(this.props.media).map(function (key) {
	            return key === "images" ? React.createElement(_Image2.default, { id: _this.props.id, image: _this.props.media[key] }) : React.createElement(_Video2.default, { id: _this.props.id, video: _this.props.media[key] });
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var src = Object.keys(this.props.image.index).map(function (key) {
	            var url = urlStart + (_this.props.id === "type-a-top-story-1" ? "480/" : "240/") + _this.props.image.index[key].originCode + _this.props.image.index[key].href.substr(_this.props.image.index[key].href.indexOf('k') + 1, _this.props.image.index[key].href.length - 1);
	            console.log(url);
	            return React.createElement(
	                "div",
	                { className: _this.props.id + "-img-container" },
	                React.createElement("img", { src: url,
	                    alt: _this.props.image.index[key].altText })
	            );
	        });
	        return React.createElement(
	            "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SharingButton = React.createClass({
	    displayName: "SharingButton",

	    handleClick: function handleClick(sharedUrl) {
	        console.log("Hola ---> " + sharedUrl);
	        /*window.plugins.socialsharing.share('http://www.bbc.co.uk' + sharedUrl);*/
	    },
	    render: function render() {
	        var address = this.props.shareLink;
	        var sharingButton = React.createElement(
	            "div",
	            null,
	            React.createElement(
	                "button",
	                { onClick: function onClick() {
	                        window.plugins.socialsharing.share(address);
	                    } },
	                "share!"
	            )
	        );
